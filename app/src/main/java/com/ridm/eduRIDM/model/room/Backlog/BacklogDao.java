...
public interface BacklogDao {
    ...
    @Query("SELECT * FROM Backlog WHERE date = :date AND section = :section AND courseName = :courseName")
    List<Backlog> getBacklogByDate(String courseName, String section, String date);
}
